...
\end{split}
\end{equation}
So we can conclude \textcolor[rgb]{0,0,1}{The $\gamma _5$-hermiticity is kept with arbitrary boundary condition and finite volume.}
...
\end{split}
\end{equation}
It is more convenient to split the $D$ operator as (note that for $yU_x$, $g(n)=y$, and $g(n)=g(n+x)$, $xU_y$ is similar.)
\begin{equation}
\begin{split}
