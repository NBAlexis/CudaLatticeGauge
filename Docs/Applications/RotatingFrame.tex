...
\begin{equation}
\begin{split}
&D_{\tau}+\mu  \bar{\psi} \gamma _4 \psi \to -\kappa \left(e^{\mu a}\bar{\psi}(n)(1-\gamma _4)U_{\tau}(n)\delta _{n,n+t} + e^{-\mu a}(1+\gamma _4) U_{-\tau}(n)\delta _{n-t,n}\right)\\
&=-\kappa \left(e^{-\frac{ia\Omega \sigma ^{12}}{2}}\bar{\psi}(n)(1-\gamma _4)U_{\tau}(n)\delta _{n,n+t} + e^{\frac{ia\Omega \sigma ^{12}}{2}}(1+\gamma _4) U_{-\tau}(n)\delta _{n-t,n}\right)
\end{split}
\end{equation}
\textcolor[rgb]{1,0,0}{It looks not satisfy the $\gamma _5$ -hermiticity.} However, using $\left(\sigma ^{12}\right)^2=1$, it is in fact
\begin{equation}
\begin{split}
&D_{\tau}+\mu  \bar{\psi} \gamma _4 \psi \to -\kappa \left(\left(\textcolor[rgb]{0,0,1}{1}-\frac{ia\Omega \sigma ^{12}}{2}\right)\bar{\psi}(n)(1-\gamma _4)U_{\tau}(n)\delta _{n,n+t} +\left(\textcolor[rgb]{0,0,1}{1}+\frac{ia\Omega \sigma ^{12}}{2}\right)(1+\gamma _4) U_{-\tau}(n)\delta _{n-t,n}\right)
\end{split}
\end{equation}
