...
\begin{equation}
\begin{split}
&S_G[U]=-\frac{\beta}{N}{\rm Re}{\rm tr}\left[U_{\mu}(n)\Sigma ^{\dagger}_{\mu}(n)\right]\\
&F_{\mu}(x)=\dot{P}_{\mu}(x)=-\partial _{\mu,n}S[U]=-\frac{\beta}{2N}\{U_{\mu}(x)\Sigma ^{\dagger}_{\mu}(x)\}_{TA}\\
