...
\subsection{\label{optimized_hmc}Optimization of HMC}
...
\subsubsection{\label{MultiStepUpdator}Multi-Step Updator}

\subsubsection{\label{CachedSolution}Cached solution}
