...
14 & $\eta _m\xi _m\eta _k\xi _l$                & ${\bf e}_k+{\bf e}_l$           & $b_1$    & $1^{+-}_A$ & $\gamma _k\gamma _m\otimes \tau _l \tau _m$  & $\rho$   & $1^{--}_A$ & $\gamma _l\otimes \tau _k$ \\
...
18 & $\eta_k\xi_k\epsilon\eta _1\eta _2\eta _3$  & ${\bf e}_x+{\bf e}_y+{\bf e}_z$ & $\rho$   & $1^{--}_A$ & $\gamma _k\gamma _4\otimes \tau _k\tau _5$   & $a_1$    & $1^{++}_A$ & $\gamma _k\gamma _5\otimes \tau _k\tau _4$ \\
...
\hline
0  & $1$                                         & $0$                             & $f_0$    & $0^{++}_S$ & $\mathbb{I}\otimes \mathbb{I}$               & $\pi$    & $0^{-+}_A$ & $\gamma_4\gamma _5\otimes \tau _4\tau _5$ \\
1  & $\epsilon$                                  & $0$                             & ?        & $0^{+-}_A$ & $\gamma _4 \otimes \tau _4$                  & $\pi$    & $0^{-+}_A$ & $\gamma _5 \otimes \tau _5$ \\
2  & $\eta _k \xi _k \epsilon$                   & $0$                             & $a_1$    & $1^{++}_A$ & $\gamma _k\gamma _5 \otimes \tau _k\tau _5$  & $\rho$   & $1^{--}_A$ & $\gamma _k\gamma _4 \otimes \tau _k\tau _4$ \\
3  & $\eta _k \xi _k$                            & $0$                             & $b_1$    & $1^{+-}_A$ & $\gamma _l\gamma _m \otimes \tau _l\tau _m$  & $\rho$   & $1^{--}_A$ & $\gamma _k \otimes \tau _k$ \\
\textcolor[rgb]{1,0,0}{4}
   & $\eta _k$                                   & ${\bf e}_k$                     & $b_1$    & $1^{+-}_A$ & $\gamma _l\gamma _m\otimes \tau _4\tau _5$   & $\omega$ & $1^{--}_S$ & $\gamma _k\otimes \mathbb{I}$                \\
\textcolor[rgb]{1,0,0}{5}
   & $\eta _k\epsilon$                           & ${\bf e}_k$                     & $a_1$    & $1^{++}_A$ & $\gamma _k\gamma _5\otimes \tau _5$          & $\rho$   & $1^{--}_A$ & $\gamma _k\gamma _4\otimes \tau _4$          \\
\textcolor[rgb]{1,0,0}{6}  
   & $\xi _k\epsilon $                           & ${\bf e}_k$                     & ?        & $0^{+-}_A$ & $\gamma _4 \otimes \tau _k \tau _4$          & $\pi$    & $0^{-+}_A$ & $\gamma _5 \otimes \tau _k\tau _5$           \\
\textcolor[rgb]{1,0,0}{7}
   & $\xi_k$                                     & ${\bf e}_k$                     & $a_0$    & $0^{++}_A$ & $\mathbb{I}\otimes \tau _k$                  & $\pi$    & $0^{-+}_A$ & $\gamma _4\gamma _5\otimes \tau _l \tau _m$  \\
\textcolor[rgb]{1,0,0}{8}
   & $\eta _k\xi _k \eta _l \epsilon$            & ${\bf e}_l$                     & $a_1$    & $1^{++}_A$ & $\gamma _m\gamma _5\otimes \tau _k\tau _4$   & $\rho$   & $1^{--}_A$ & $\gamma _m\gamma _4\otimes \tau _k \tau _5$  \\
\textcolor[rgb]{1,0,0}{$9$}
   & $\eta_k\xi_k\eta_l$                         & ${\bf e}_l$                     & $b_1$    & $1^{+-}_A$ & $\gamma _k\gamma _l \otimes \tau _k$         & $\rho$   & $1^{--}_A$ & $\gamma _m \otimes \tau _l\tau _m$           \\
10 & $\eta _k\eta _l \epsilon _{23}$             & ${\bf e}_k+{\bf e}_l$           & $h_1$    & $1^{+-}_S$ & $\gamma _k\gamma _l\otimes \mathbb{I}$       & $\rho$   & $1^{--}_A$ & $\gamma _m\otimes \tau _4\tau _5$ \\
11 & $\eta _k\eta _l \epsilon\epsilon _{23}$     & ${\bf e}_k+{\bf e}_l$           & $a_1$    & $1^{++}_A$ & $\gamma _m\gamma _5\otimes \tau _4$          & $\rho$   & $1^{--}_A$ & $\gamma _m\gamma _4\otimes \tau _5$ \\
12 & $\xi _k\xi _l \epsilon _{23}$               & ${\bf e}_k+{\bf e}_l$           & $a_0$    & $0^{++}_A$ & $\mathbb{I}\otimes \tau _k\tau _l$           & $\pi$    & $0^{-+}_A$ & $\gamma _4\gamma _5\otimes \tau _m$ \\
13 & $\xi _k\xi _l \epsilon \epsilon _{23}$      & ${\bf e}_k+{\bf e}_l$           & ?        & $0^{+-}_A$ & $\gamma _4\otimes \tau _m\tau _5$            & $\pi$    & $0^{-+}_A$ & $\gamma _5\otimes \tau _m\tau _4$ \\
14 & $\eta _m\xi _m\eta _k\xi _l\epsilon_{23}$   & ${\bf e}_k+{\bf e}_l$           & $b_1$    & $1^{+-}_A$ & $\gamma _k\gamma _m\otimes \tau _l \tau _m$  & $\rho$   & $1^{--}_A$ & $\gamma _l\otimes \tau _k$ \\
15 & $\eta _m\xi _m\eta _k\xi _l\epsilon\epsilon_{23}$ & ${\bf e}_k+{\bf e}_l$     & $a_1$    & $1^{++}_A$ & $\gamma _l\gamma _5\otimes \tau _k \tau _5$  & $\rho$   & $1^{--}_A$ & $\gamma _l\gamma _4\otimes \tau _k\tau _4$ \\
\textcolor[rgb]{1,0,0}{16}
   & $\eta _1\eta _2\eta _3$                     & ${\bf e}_x+{\bf e}_y+{\bf e}_z$ & $a_0$    & $0^{++}_A$ & $\mathbb{I}\otimes \tau _4\tau _5$           & $\eta$  & $0^{-+}_S$ & $\gamma _4\gamma _5\otimes \mathbb{I}$       \\
\textcolor[rgb]{1,0,0}{17}
   & $\eta _1\eta _2\eta _3\epsilon$             & ${\bf e}_x+{\bf e}_y+{\bf e}_z$ & ?        & $0^{+-}_A$ & $\gamma _4\otimes \tau _5$                   & $\pi$    & $0^{-+}_A$ & $\gamma _5\otimes \tau _4$                   \\
\textcolor[rgb]{1,0,0}{18} 
   & $\eta_k\xi_k\epsilon\eta _1\eta _2\eta _3$  & ${\bf e}_x+{\bf e}_y+{\bf e}_z$ & $a_1$    & $1^{++}_A$ & $\gamma _k\gamma _5\otimes \tau _k\tau _4$   & $\rho$   & $1^{--}_A$ & $\gamma _k\gamma _4\otimes \tau _k\tau _5$   \\
\textcolor[rgb]{1,0,0}{19} 
   & $\eta_k\xi_k\eta _1\eta _2\eta _3$          & ${\bf e}_x+{\bf e}_y+{\bf e}_z$ & $b_1$    & $1^{+-}_A$ & $\gamma _l\gamma _m\otimes \tau _k$          & $\rho$ & $1^{--}_A$ & $\gamma_k\otimes\tau_l\tau_m$        \\
\hline
\end{tabular}
\end{center}
\caption{\label{tab:staggeredMesontxyz}In $t-x-y-z$ order. In this case, $\eta_i=(-1)^{\sum _{j<i}n_j}$, $\xi_i=(-1)^{\sum _{j<i}n_j}$, $\epsilon=(-1)^{\sum _{i}n_i}$, where the sum is over $n_{x,y,z}$.
Note that, for some $k$, there is a sign difference between $k=3,l=1,m=2$ and others, which cannot be characteristic using $\epsilon _{klm}$, we use a $\epsilon _{13}$ instead, for $k=1,l=2,m=3$ and $k=2,l=3,m=1$, $\epsilon _{23}=+1$, for $k=3,m=1,l=2$, $\epsilon _{23}=-1$. Note that, sometimes there is a $-1$ factor on $+\sigma$ or $-\sigma$ which can be absorbed in to $A^{\pm}$~(where $A^{\pm}$ is coefficient of correlators $C^{\pm}(t)=A^{\pm}\left(e^{-m^{\pm}t}+e^{-m^{\pm}(L_t-t)}\right)$), therefore omitted.}
\end{table}
