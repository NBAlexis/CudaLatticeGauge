...
from JacknifePrograms import LoadMathematicaCSV, JacknifeWilsonLoop, PrintAsMathematicaArray, MatchingUsingR0, \
    MatchingUsingR1

folderHead = "G:\\Quench242424-48\\Wilson\\"
...
ar0, aer0 = MatchingUsingR0(r0lst, r0elst)
ar1, aer1 = MatchingUsingR1(r1lst, r1elst)
...
print(PrintAsMathematicaArray(ar0, "ar0"))
print(PrintAsMathematicaArray(aer0, "ar0e"))
print(PrintAsMathematicaArray(ar1, "ar1"))
print(PrintAsMathematicaArray(aer1, "ar1e"))
# """
