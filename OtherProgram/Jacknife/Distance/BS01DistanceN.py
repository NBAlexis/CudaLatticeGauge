...
klst = findK(folderstart, "distancen")
distlst = findDistances(folderstart, "distancen")
...
for i in range(len(betalst)):
    wilsonloop = LoadMathematicaCSV(f"{folderstart}BS01Wilsonloops\\DistanceN\\BS01_DistanceN__{betalst[i]}_wilsonloops.csv")
...
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceNK1.csv', k1lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceNK2.csv', k2lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceNK3.csv', k3lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceNK4.csv', k4lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceNK5.csv', k5lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceNK6.csv', k6lst, delimiter=',')
