...
for i in range(len(betalst)):
    wilsonloop = LoadMathematicaCSV(f"{folderstart}BS01Wilsonloops\\DistanceFoldN\\BS01_DistanceFoldN__{betalst[i]}_wilsonloops.csv")
...
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceFoldN.csv', kalllst, delimiter=',')
