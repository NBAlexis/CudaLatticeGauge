...
for i in range(len(betalst)):
    wilsonloop = LoadMathematicaCSV(f"{folderstart}QuenchWilsonLoop\\DistanceN\\BSQ_DistanceN__{betalst[i]}_wilsonloops.csv")
...
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BSQDistanceNK1.csv', k1lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BSQDistanceNK2.csv', k2lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BSQDistanceNK3.csv', k3lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BSQDistanceNK4.csv', k4lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BSQDistanceNK5.csv', k5lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BSQDistanceNK6.csv', k6lst, delimiter=',')
