...
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceRK1.csv', k1lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceRK2.csv', k2lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceRK3.csv', k3lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceRK4.csv', k4lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceRK5.csv', k5lst, delimiter=',')
np.savetxt(f'{folderstart}\\WilsonLoopRes\\BS01DistanceRK6.csv', k6lst, delimiter=',')
