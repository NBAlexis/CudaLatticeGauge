...
prop = np.load("data/wallsource_propagator_cfg_100.npy")
clg_prop_r = transformStaggeredFermionFromCon("data/clg_wallsource_cfg_100_r_double.con", 12, 12, 12, 12, True)
clg_prop_g = transformStaggeredFermionFromCon("data/clg_wallsource_cfg_100_g_double.con", 12, 12, 12, 12, True)
clg_prop_b = transformStaggeredFermionFromCon("data/clg_wallsource_cfg_100_b_double.con", 12, 12, 12, 12, True)
