...
//                CCString sFileNameWriteJG;
//                CCString sFileNameWriteJGIn;
//                CCString sFileNameWriteJGL;
//                CCString sFileNameWriteJGS;
//
//                CCString sFileNameWriteJFS;
//                CCString sFileNameWriteJFL;
//                CCString sFileNameWriteJFLPure;
//                CCString sFileNameWriteJPot;
//
//                sFileNameWriteJG.Format(_T("%s_angularJG_Nt%d_R.csv"), sCSVSavePrefix.c_str(), _HC_Lt);
//                sFileNameWriteJGIn.Format(_T("%s_angularJG_Nt%d_In.csv"), sCSVSavePrefix.c_str(), _HC_Lt);
//                sFileNameWriteJGL.Format(_T("%s_angularJGL_Nt%d_O%d.csv"), sCSVSavePrefix.c_str(), _HC_Lt, uiOmega);
//                sFileNameWriteJGS.Format(_T("%s_angularJGS_Nt%d_O%d.csv"), sCSVSavePrefix.c_str(), _HC_Lt, uiOmega);
//                sFileNameWriteJFS.Format(_T("%s_angularJFS_Nt%d_O%d.csv"), sCSVSavePrefix.c_str(), _HC_Lt, uiOmega);
//                sFileNameWriteJFL.Format(_T("%s_angularJFL_Nt%d_O%d.csv"), sCSVSavePrefix.c_str(), _HC_Lt, uiOmega);
//                sFileNameWriteJFLPure.Format(_T("%s_angularJFLPure_Nt%d_O%d.csv"), sCSVSavePrefix.c_str(), _HC_Lt, uiOmega);
//                sFileNameWriteJPot.Format(_T("%s_angularJPot_Nt%d_O%d.csv"), sCSVSavePrefix.c_str(), _HC_Lt, uiOmega);
//
//                TArray<TArray<Real>> jgOverR;
//                TArray<TArray<Real>> jglOverR;
//                TArray<TArray<Real>> jgsOverR;
//                TArray<TArray<Real>> jfsOverR;
//                TArray<TArray<Real>> jflOverR;
//                TArray<TArray<Real>> jfpureOverR;
//                TArray<TArray<Real>> jpotOverR;
//
//                TArray<Real> jgIn;
//                TArray<Real> jglIn;
//                TArray<Real> jgsIn;
...
//                    for (INT i = 0; i < pPL->m_lstR.Num(); ++i)
//                    {
//                        thisConfiguration.AddItem(pJG->m_lstJG[j * pPL->m_lstR.Num() + i]);
//                    }
//                    jgOverR.AddItem(thisConfiguration);
//                    jgIn.AddItem(pJG->m_lstJGInner[j]);
//                }
//                WriteStringFile(sFileNameWriteJG, ExportRealArray2(jgOverR));
//                CCString sHead;
//                sHead.Format("(* Omega = %d *)\n", uiOmega);
//                AppendStringFile(sFileNameWriteJGIn, sHead);
//                AppendStringFile(sFileNameWriteJGIn, ExportRealArray(jgIn));
//
//                //extract result
