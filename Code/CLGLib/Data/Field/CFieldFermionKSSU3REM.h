    ...
    UINT bXorY, UBOOL bPlusMu, UBOOL bPlusTau)
{
    ...
    dir1[1] = iMu;
    dir1[2] = iTau;
    deviceSU3 sRet = _deviceLinkMP(pDeviceData, sStartSite, sCenterSite, 3, byFieldId, fQBz, dir1);
    
    dir1[0] = iMu;
    dir1[1] = iTau;
    dir1[2] = iMu;
    sRet.Add(_deviceLinkMP(pDeviceData, sStartSite, sCenterSite, 3, byFieldId, fQBz, dir1));
    ...
    UINT bXorY, UBOOL bPlusMu, UBOOL bPlusTau)
{
    ...
    deviceSU3 sRet = _deviceLinkMP(pDeviceData, sStartSite, sCenterSite, 2, byFieldId, fQBz, dir1);
    dir1[0] = iTau; dir1[1] = iMu;
    sRet.Add(_deviceLinkMP(pDeviceData, sStartSite, sCenterSite, 2, byFieldId, fQBz, dir1));
    ...
    if (1 == byMu)
    {
        const Real fPhase = (x_p_taumu__muSite.x - sCenterSite.x + F(0.5)) * fQBz;
        if (bLastLinkDagger)
        {
    ...
    else if (0 == byMu && x_p_taumu__muSite.x == static_cast<INT>(_DC_Lx) - 1)
    {
        const Real fPhase = (x_p_taumu__muSite.y - sCenterSite.y + F(0.5)) * fQBz;
        if (bLastLinkDagger)
        {
            sRet.MulComp(_make_cuComplex(_cos(fPhase), _sin(fPhase)));
        }
    ...
    UBOOL bPlusX, UBOOL bPlusY, UBOOL bPlusTau)
{
    ...
    dir1[0] = iX; dir1[1] = iY;
    deviceSU3 sRet1(_deviceLinkMP(pDeviceData, sStartSite, sCenterSite, 2, byFieldId, fQBz, dir1));

    dir1[0] = iY; dir1[1] = iX;
    sRet1.Add(_deviceLinkMP(pDeviceData, sStartSite, sCenterSite, 2, byFieldId, fQBz, dir1));
    ...
    dir1[0] = iX; dir1[1] = iT;
    deviceSU3 sRet2 = _deviceLinkMP(pDeviceData, sStartSite, sCenterSite, 2, byFieldId, fQBz, dir1);

    dir1[0] = iT; dir1[1] = iX;
    sRet2.Add(_deviceLinkMP(pDeviceData, sStartSite, sCenterSite, 2, byFieldId, fQBz, dir1));
     ...
     || (!n_xt__y.NeedToDagger() && !bPlusY))
    {
        ...
        const Real fPhase = (n_xt_site.x - sCenterSite.x + F(0.5))* fQBz;
    ...
    dir1[0] = iY; dir1[1] = iT;
    sRet2 = _deviceLinkMP(pDeviceData, sStartSite, sCenterSite, 2, byFieldId, fQBz, dir1);
     ...
     || (!n_yt__x.NeedToDagger() && !bPlusX))
    {
        ...
        if (n_yt_site.x == static_cast<INT>(_DC_Lx) - 1)
        {
            const Real fPhase = (n_yt_site.y - sCenterSite.y + F(0.5)) * fQBz;
            sRet2.MulComp(_make_cuComplex(_cos(fPhase), _sin(fPhase)));
        }
    }
    else
