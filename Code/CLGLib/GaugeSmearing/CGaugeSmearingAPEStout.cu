...
void CGaugeSmearingAPEStout::GaugeSmearing(CFieldGauge* pGauge, const CFieldGauge* pOrignal, CFieldGauge* pStaple, UBOOL bProject)
{
    ...
    for (UINT i = 0; i < m_uiIterate; ++i)
    {
        ...
        _LAUNCH_KERNEL(_kernelAPEStoutSU3, block, threads, 
