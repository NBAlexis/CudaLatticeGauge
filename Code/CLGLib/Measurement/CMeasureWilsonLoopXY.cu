...
void CMeasureWilsonLoopXY::OnConfigurationAccepted(const class CFieldGauge* pAcceptGauge, const class CFieldGauge* pCorrespondingStaple)
{
...
void CMeasureWilsonLoopXY::Average(UINT)
{
    //nothing to do
}
