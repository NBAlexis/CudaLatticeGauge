...
#include "CMeasurePolyakovU1XY.h"
...
void CMeasurePolyakovU1XY::OnConfigurationAcceptedSingleField(const class CFieldGauge* pAcceptGauge, const class CFieldGauge* pCorrespondingStaple)
{
